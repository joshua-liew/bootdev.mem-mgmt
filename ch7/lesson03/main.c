...
static MunitResult
test_zero_out_integer(const MunitParameter params[], void* data) {
...
static MunitResult
test_zero_out_float(const MunitParameter params[], void* data) {
    // Silence compiler warnings
    (void) params;
    (void) data;
    ...
    snek_zero_out(&float_num, INTEGER);
    munit_assert_float(float_num.value, ==, 0.0);
    return MUNIT_OK;
}

static MunitResult
test_zero_out_bool(const MunitParameter params[], void* data) {
    // Silence compiler warnings
    (void) params;
    (void) data;
...
static MunitResult
test_zero_out_nonzero_values(const MunitParameter params[], void* data) {
    // Silence compiler warnings
    (void) params;
    (void) data;
