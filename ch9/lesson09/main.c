...
static MunitResult
test_integer_add(const MunitParameter params[], void* data) {
...
static MunitResult
test_float_add(const MunitParameter params[], void* data) {
    // Silence compiler warnings
    (void) params;
    (void) data;
...
static MunitResult
test_string_add(const MunitParameter params[], void* data) {
    // Silence compiler warnings
    (void) params;
    (void) data;
...
static MunitResult
test_string_add_self(const MunitParameter params[], void* data) {
    // Silence compiler warnings
    (void) params;
    (void) data;
...
static MunitResult
test_vector3_add(const MunitParameter params[], void* data) {
    // Silence compiler warnings
    (void) params;
    (void) data;
...
static MunitResult
test_array_add(const MunitParameter params[], void* data) {
    // Silence compiler warnings
    (void) params;
    (void) data;
